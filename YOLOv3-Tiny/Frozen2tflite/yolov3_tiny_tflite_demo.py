...
#from utils import * 
from utils import letterbox_image, featuresToBoxes, nms_boxes, get_anchors, get_classes
import argparse
...
parser.add_argument("-t", "--threshold", help="Detection threshold.", type=float, default=0.25)
parser.add_argument("--edge_tpu",  help="Whether to delegate to Edge TPU or run on CPU.", action="store_true")
parser.add_argument("--quant", help="Indicates whether the model is quantized.", action="store_true")
parser.add_argument("--cam", help="Run inference on webcam.", action="store_true")
